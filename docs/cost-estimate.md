...
Infrastructure cost is separate from support and maintenance.

Reasonable support pricing models:

- Light maintenance retainer: `5 to 8 hours/month`
- Active season support: `10 to 20 hours/month`
- Annual hardening before launch: extra `20 to 40 hours`

If priced commercially, you should separate:

- infrastructure hosting
- bug fixes and enhancements
- seasonal reopen / close support
- compliance and security updates

## Recommendation for Stakeholder Proposal

Use these numbers in the proposal:

- Demo/pilot hosting: `~$100/month`
- Lean production: `~$200 to $400/month`
- Safer production with more redundancy: `~$300 to $700/month`
- Seasonal annual infrastructure: `~$1,000 to $4,200/year`, depending on whether you keep HA enabled and how much data you retain online

That is realistic enough for early stakeholder approval without pretending the final AWS bill can be exact before capacity and retention decisions are locked.
